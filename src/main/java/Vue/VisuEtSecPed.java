...
public class VisuEtSecPed extends JFrame {
	...
	public VisuEtSecPed(String id, String nom, String prenom) {
		...
		tableUE = new JTable();
		tableUE.setModel(new DefaultTableModel(
			new Object[][] {
				{"MIASHS", "MIAGE", "MI", "Informatique", null},
				{"MIASHS", "LOL", "LOA", "Gestion", "30"},
			},
			new String[] {
				"Mention", "Parcours", "Code", "Nom", "Cr\u00E9dits"
			}
		));
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"None", "MIAGE", "MECANIQUE", "ART", "INFORMATIQUE", "RESEAU"}));
